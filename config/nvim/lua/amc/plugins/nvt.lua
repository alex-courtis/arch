...
local function on_attach(bufnr)
  ...
  vim.keymap.set('n', '<Space>k', api.node.navigate.git.prev_skip_gitignored, opts('Prev Git'))
  vim.keymap.set('n', '<BS>k',    api.node.navigate.git.prev_skip_gitignored, opts('Prev Git'))
  vim.keymap.set('n', '<Space>j', api.node.navigate.git.next_skip_gitignored, opts('Next Git'))
  vim.keymap.set('n', '<BS>j',    api.node.navigate.git.next_skip_gitignored, opts('Next Git'))
