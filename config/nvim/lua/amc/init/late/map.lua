...
K.n___("<C-Space>",      "<C-w>p",              "<C-w>w")
K.n___("<C-CR>",         "<C-w>w",              "<C-w>w")
K.n___("<C-S-CR>",       "<C-w>W",              "<C-w>W")
...
K.ns__("fd", telescope.find_files,                  "Find Files")
K.ns__("fd", telescope.find_files_directory_buffer, "Find Files: Directory, Buffer")
K.ns__("fD", telescope.find_files_directory_prompt, "Find Files: Directory, Prompt")
...
K.nsl_("mp", dev.cppcheck,       "make cppcheck")
...
K.nsl_("t",  "<Nop>",                               "<Nop>")
K.vsl_("t",  ":sort<CR>",                           "Sort")
K.vsl_("t",  ":sort i<CR>",                         "Sort Insensitive")
